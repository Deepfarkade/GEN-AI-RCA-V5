...
class ChatService:
    ...
    #         persona = user.get("persona")  # fallback to "ESP" if missing, or raise if you want
    ...
    #         # Build the ChatSession with the user’s persona
    #         session = ChatSession(
    #             id=str(ObjectId()),
    #             title="New Analysis",
    ...
    #                     next_question=first_question  # now persona-based
    #                 )
    #             ]
    #         )
    ...
    #         user_id=str(user["_id"]),
    #         session_id=session_id,
    #         current_user=user   # <--- pass the entire user
    #     )
    ...
    #             sender="bot",
    #             session_id=session_id,
    #             timestamp=datetime.now(pytz.timezone("Asia/Kolkata")), #datetime.utcnow(),
